...
console.log(`Buscando ${SEARCH_TERMS.length} terminos de Gondola SAMAN (${ALL_BRANDS.length} marcas)\n`);
...
const csvPath = `data/output/gondola_saman_${stamp}.csv`;
const jsonPath = `data/output/gondola_saman_${stamp}.json`;
